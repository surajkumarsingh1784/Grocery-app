        ...
        try {
            ...
            if (data.success) {
                if (paymentOption === "COD") {
                    ...
                    window.location.replace(data.url); // Redirect to Stripe payment
                }
            } else {
        ...
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Tax (2%)</span><span>{currency}{(parseFloat(getCartAmount()) * 2 / 100).toFixed(2)}</span>
                    </p>
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span><span>{currency}{(parseFloat(getCartAmount()) + parseFloat(getCartAmount()) * 2 / 100).toFixed(2)}</span>
                    </p>
                </div>
